...
namespace Caching.Domain.Extentions;
...
public static class LinqExtention
{
    ...
    public static IEnumerable<TSource> ApplySpecification<TSource>(this IEnumerable<TSource> source, QuerySpecification<TSource> querySpecification) 
        where TSource : IEntity
    {
        source = source.ApplyPredicates(querySpecification).ApplyOrderding(querySpecification).ApplyPagination(querySpecification);
    ...
    public static IEnumerable<TSource> ApplyOrderding<TSource>(this IEnumerable<TSource> source, QuerySpecification<TSource> querySpecification)
        where TSource : IEntity
    {
        if(!querySpecification.OrderingOptions.Any())
            source.OrderBy(entity => entity.Id);
